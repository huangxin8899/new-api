...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/verification", middleware.EmailVerificationRateLimit(), middleware.AdaptiveTurnstileCheck(common.ChallengeScopeAuth), controller.SendEmailVerification)
		apiRouter.GET("/reset_password", middleware.CriticalRateLimit(), middleware.AdaptiveTurnstileCheck(common.ChallengeScopeAuth), controller.SendPasswordResetEmail)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			userRoute.POST("/register", middleware.CriticalRateLimit(), anonymousRequestBodyLimit, middleware.AdaptiveTurnstileCheck(common.ChallengeScopeAuth), controller.Register)
			userRoute.GET("/login/encryption-key", middleware.DisableCache(), controller.GetPasswordEncryptionKey)
			userRoute.POST("/login", middleware.CriticalRateLimit(), middleware.DisableCache(), anonymousRequestBodyLimit, middleware.AdaptiveTurnstileCheck(common.ChallengeScopeAuth), controller.Login)
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/xorpay/amount", controller.RequestXorPayAmount)
				selfRoute.POST("/xorpay/pay", middleware.CriticalRateLimit(), controller.RequestXorPayPay)
				selfRoute.GET("/xorpay/order", controller.QueryXorPayOrder)
